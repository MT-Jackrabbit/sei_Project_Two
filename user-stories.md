...
1. Color Schema - Light Theme (whites and white grays, youtube type them)
2. Font choice - None specific clean to read (blocks san-serif)
3. Slideshow?? - Carasel (three images)
4. Timer for auto show?? - every couple seconds
5. Text overlay on images?? - none
6. Type of transition?? - slide transition (like amazon)
9. Arrow style?? - little arrows
10. Company Name - Wayfarer
11. Company Logo - Non specific
12. Only profile if signed in
13. Standard link - little icons
14. No special transition for modal on login/sign
15. Login and signup on seperate modals
16. Buttons for interaction (dribble has good examples of forms)
17. Username but email if possible
18. Password standard encription
19. Match the city page (left user profile, right is the post)
20. Need to be able organize posts by city
21. Search the posts on the page for info
---
